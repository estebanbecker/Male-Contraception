...
\usepackage[backend=biber,style=ieee,autocite=plain,ibidtracker=constrict]{biblatex}
\usepackage{csquotes}
\usepackage{hyperref}
\usepackage{caption}
\usepackage{labels}
...
\hline
\textbf{Méthode} & \textbf{Allemagne} & \textbf{France} & \textbf{Espagne} & \textbf{Suède} & \textbf{États-Unis} & \textbf{Argentine} & \textbf{Brésil} & \textbf{Mexique} & \textbf{Indonésie} \\
\hline
Retrait & 46.9 & 51.8 & 57.8 & 70.5 & 55.4 & 32.8 & 23.7 & 24.1 & 35.7 \\
Préservatif & 90.0 & 81.3 & 90.7 & 92.4 & 83.4 & 84.2 & 75.0 & 69.8 & 46.5 \\
Vasectomie & 11.9 & 0.3 & 14.4 & 6.9 & 19.4 & 1.4 & 2.3 & 4.3 & 1.8 \\
\hline
\end{tabular}%
}
...
\begin{tabular}{|l||c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Décideur de la méthode contraceptive} & \textbf{Allemagne} & \textbf{France} & \textbf{Espagne} & \textbf{Suède} & \textbf{États-Unis} & \textbf{Argentine} & \textbf{Brésil} & \textbf{Mexique} & \textbf{Indonésie} \\
\hline
Vous & 3.7 & 6.3 & 6.3 & 1.9 & 8.0 & 10.5 & 8.4 & 11.9 & 6.5 \\
Partenaire & 19.3 & 39.6 & 12.2 & 23.3 & 17.5 & 11.0 & 29.8 & 13.3 & 30.5 \\
Les deux & 77.0 & 54.1 & 81.5 & 74.8 & 74.4 & 78.3 & 61.8 & 74.8 & 63.0 \\
\hline
\end{tabular}%
}
\caption{Décideur de la méthode contraceptive dans différents pays\cite{heinemannAttitudesMaleFertility2005}}
\end{table}

On peut voir que dans la majorité des cas, la méthode de contraception est choisie par les deux personnes composants un couple. Cependant, il existe une différence entre la France et l'Indonésie où dans plus de 30 \% (voir quasiment 40 \% pour la France) des couples, c'est la femme qui effectue le choix et d'autres pays comme l'Espagne ou les états-unie où c'est le cas dans moins de 20 \% des cas. 
...
\begin{tabular}{|l||c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Volonté de subir une vasectomie} & \textbf{Allemagne} & \textbf{France} & \textbf{Espagne} & \textbf{Suède} & \textbf{États-Unis} & \textbf{Argentine} & \textbf{Brésil} & \textbf{Mexique} & \textbf{Indonésie} \\
\hline
Pas du tout & 38.3 & 82.9 & 33.6 & 75.7 & 48.5 & 78.3 & 47.4 & 31.3 & 67.8 \\
Possible dans certaines circonstances & 45.0 & 16.4 & 51.6 & 16.7 & 35.3 & 16.1 & 24.9 & 30.2 & 18.3 \\
J'y pense & 14.4 & 0.4 & 7.7 & 7.1 & 11.7 & 3.4 & 22.4 & 17.8 & 13.3 \\
\hline
\end{tabular}%
}
\caption{Volonté d'effectuer une vasectomie dans différents pays\cite{heinemannAttitudesMaleFertility2005}}
\end{table}
...
\begin{tabular}{|l||c|c|c|c|c|c|c|c|c|}
\hline
 & \textbf{Allemagne} & \textbf{France} & \textbf{Espagne} & \textbf{Suède} & \textbf{États-Unis} & \textbf{Argentine} & \textbf{Brésil} & \textbf{Mexique} & \textbf{Indonésie} \\
\hline
Je me ferai stériliser plus tard & 2.3 & 0.3 & 6.9 & 0.4 & 4.6 & 2.3 & 5.2 & 20.7 & 0.6 \\
Je suis déjà stérilisé & 10.1 & 0.3 & 11.1 & 3.2 & 17.5 & 2.5 & 2.2 & 4.0 & 1.2 \\
\hline
\end{tabular}%
}
\caption{Disposition envers la stérilisation masculine dans différents pays\cite{heinemannAttitudesMaleFertility2005}}
\end{table}


On peut voir que la Vasectomie étant une méthode de stérilisation, les résultats sont globalement similaires, même si l'on peut voir de grandes différences telles que l'Indonésie ou 13,3 \% des interrogés disent penser à effectuer une vasectomie, mais seulement 0.6 \% pense se faire stériliser plus tard. Ceci est peut-être dû au terme : « stérilisé » qui est un terme plus fort que la vasectomie, en effet, on l'utilise aussi pour les animaux. De plus, on peut voir une corrélation entre la volonté à effectuer une vasectomie et le pourcentage d'hommes ayant effectué une vasectomie dans le tableau : \ref{table:contraceptionparpays}  \cite{heinemannAttitudesMaleFertility2005}
...
\hline
 & \textbf{Allemagne} & \textbf{France} & \textbf{Espagne} & \textbf{Suède} & \textbf{États-Unis} & \textbf{Argentine} & \textbf{Brésil} & \textbf{Mexique} & \textbf{Indonésie} \\
\hline
Volontaire & 69.0 & 47.0 & 71.4 & 58.1 & 49.3 & 44.5 & 62.7 & 65.4 & 28.5 \\
Indécis & 24.4 & 34.9 & 26.2 & 17.4 & 38.4 & 13.2 & 12.8 & 8.9 & 37.3 \\
Désapprobateur & 6.6 & 17.5 & 2.4 & 24.4 & 12.4 & 42.3 & 24.5 & 25.7 & 34.2 \\
\hline
\end{tabular}%
}
\caption{Disposition envers la nouvelle méthode de contrôle de la fertilité masculine dans différents pays\cite{heinemannAttitudesMaleFertility2005}}
\end{table}
