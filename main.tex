...
\usepackage[includefoot,a4paper, total={7in, 10in}]{geometry}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/scientiphique/CryptorchidismForms.jpg}
...
Cependant, malgré qu'aucun organisme de santé a officiellement validé cette méthode, on peut retrouver de multiples témoignages de personnes qui l'utilisent avec succès.
