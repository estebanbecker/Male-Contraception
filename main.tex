...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        \hline
        \textbf{Méthode} & \textbf{Connaissances} & \textbf{Confiance} & \textbf{Probabilité d'utilisation} & \textbf{Efficacité pratique (\%)} \\
        \hline
...
Cependant, on peut voir que les gens ont une très grande confiance envers le préservatif (8.43) mais une très petite avec le retrait (2.05) alors que leur score d'efficacité réelle ne sont écarté que de 6 points.
